...
namespace BNG {
    ...
    public class HandPhysics : MonoBehaviour {
        ...
        public void OnCollisionExit(Collision collision) { colliding = false; }
        ...
        void Update() {
            if (colliding)
            {
                InputBridge.Instance.VibrateController(0.1f, 0.1f, 0.1f, right ? ControllerHand.Right : ControllerHand.Left);
            }
            updateHandGraphics();
